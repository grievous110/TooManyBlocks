...
public:
	...
	Texture(TextureType type, unsigned int width, unsigned int height, int channels = 4, const void* data = nullptr, TextureFilter filterMode = TextureFilter::Nearest, TextureWrap wrapMode = TextureWrap::Repeat);
